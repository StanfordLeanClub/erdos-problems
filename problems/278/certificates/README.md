...
\### `residual\_core\_certificate\_v1.md`
...
\\operatorname{Opt}\_{\\mathrm{full}}(K\_n,n-4)
...
\### `residual\_core\_certificate\_checker\_v1.py`
...
The \\(K\_n,t=n-4\\) theorem should be treated as:
